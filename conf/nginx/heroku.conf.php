#user  nobody;
worker_processes <?=getenv('NGINX_PROCESSES')?:'auto'?>;
...
events {
# modified by teleforge
    worker_connections <?=getenv('NGINX_WORKERS')?:1024?>;
}
...
http {
    ...
    # Teleforge todo: add http include script here?
